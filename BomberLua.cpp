...
// Récupère le temps écoulé depuis le lancement du programme
// Equivalent à SDL_GetTicks()/1000.0 mais ne dépend pas de SDL
...
double getTicks()
{
    ...
    if(init_sec == -1)
        init_sec = tv.tv_sec - 1; // On ne veut pas de précision, juste un
                                  // compteur...
